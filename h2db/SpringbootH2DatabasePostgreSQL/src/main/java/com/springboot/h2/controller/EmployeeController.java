...
import com.springboot.h2.service.ImagesService;
...
public class EmployeeController {
    ...
    @PostMapping(value = "/employee_avatar_form_save")
    public String showAvatarFormSave(@RequestParam(value = "avatarPath") String avatarPath, Model model) {
        Employee employee = new Employee();
        employee.setStartJobDate(LocalDate.now());
    ...
    @GetMapping(value = "/employee_avatar_form")
    public String showAvatarForm(Model model) {
        model.addAttribute("allAvatars", imagesService.getAllAvatars());
        return "employee/employee_avatar_form";
    }
